...
namespace WebStore.Data
{
    public static class TestData
    {
        ...
        public static IEnumerable<Section> Sections { get; } = new[]
        {
            ...
            new Section { Id = 19, Name = "Fendi-1", Order = 0, ParentId = 18 },
            new Section { Id = 20, Name = "Guess-1", Order = 1, ParentId = 18 },
            new Section { Id = 21, Name = "Valentino-1", Order = 2, ParentId = 18 },
        ...
        public static IEnumerable<Product> Products { get; } = new[]
        {
            ...
            new Product { Id = 12, Name = "Летний костюм", Price = 1025, ImageUrl = "product12.jpg", Order = 11, SectionId = 5, BrandId = 3 },
        };
    }
}
